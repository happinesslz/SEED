...
def dn_post_process(outputs_class, outputs_coord, outputs_iou, dn_meta, aux_loss, _set_aux_loss):
    """
    ...
    if dn_meta and dn_meta["pad_size"] > 0:
        ...
        if aux_loss:
            out["aux_outputs"] = _set_aux_loss(output_known_class[:-1], output_known_coord[:-1], output_known_iou[:-1])
